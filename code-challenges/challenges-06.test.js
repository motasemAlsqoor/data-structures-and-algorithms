...
Write a function named getCourseKeys that takes in the courseInfo object and returns
 an array containing the keys for the courseInfo object.
...
const hasChildrenValues = (arr, character) => {  
  ...
  for (let index = 0; index < arr.length; index++) {
    if (arr[index].name==character) {
      hasChildren==arr[index].children.length!=0;
      console.log(character+"has chilf"+hasChildren)
      return true;
    }
  }
return hasChildren;
