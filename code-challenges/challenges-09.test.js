...
const addPurchases = (arr) => {
  ...
  return arr.reduce((ac,cr)=>ac.purchasePrice+cr.purchasePrice);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return starWarsData.reduce(((ac,cr)=>{return ac+cr.name+"."}),"").split(".").slice(0,-1);
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split("").reduce((ac,cr,i,a)=>a[i]+ac);
};
